...
const Button = ({
    ...
    const variantSytles = {
        primary: "bg-linear-to-r from-emrald-500 to-teal-500 text-white shadow-lg shadow-emrald-500/25 hover:from-emrald-600 hover:to-teal-600 hover:shadow-xl hover:shadow-emrald-500/30",
